...
def construct_query_and_database_sets(base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
    ...
    for folder in folders:
        ...
        # print("len(ind_nn):", len(df_database['file']))
        # print("len(ind_r):", len(df_test['file']))
        ...
        print('len(df_test[\'file\']): ', len(df_test['file']))
        sum += len(df_test['file'])
        print('sum = ', sum)
    ...
    for folder in folders:
        ...
        for index, row in df_locations.iterrows():
            # entire business district is in the test set
            if (output_name == "business"):             # output_name=“oxford”
    ...
    print('database_sets: ', len(database_sets))
...
print(folders)
construct_query_and_database_sets(base_path, runs_folder, folders, featurecloud_fols, "pointcloud_locations_20m.csv",
...
construct_query_and_database_sets(base_path, runs_folder, folders, featurecloud_fols, "pointcloud_centroids_25.csv", p_dict["university"], "university")
...
construct_query_and_database_sets(base_path, runs_folder, folders, featurecloud_fols, "pointcloud_centroids_25.csv", p_dict["residential"], "residential")
...
construct_query_and_database_sets(base_path, runs_folder, folders, featurecloud_fols, "pointcloud_centroids_25.csv", p_dict["business"], "business")
